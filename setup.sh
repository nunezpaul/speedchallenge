...
ffmpeg -i data/train.mp4 -start_number 0 -qscale:v 2 data/train_images/img%d.jpg -hide_banner; echo train images done!
ffmpeg -i data/test.mp4 -start_number 0 -qscale:v 2 data/test_images/img%d.jpg -hide_banner; echo test images done!
